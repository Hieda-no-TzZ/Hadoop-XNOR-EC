...
import org.apache.hadoop.io.erasurecode.codec.XNORErasureCodec;
...
public final class CodecUtil {
  ...
  /** Erasure coder XNOR codec. */
  public static final String IO_ERASURECODE_CODEC_XNOR_KEY =
      IO_ERASURECODE_CODEC + "xnor";
  public static final String IO_ERASURECODE_CODEC_XNOR =
      XNORErasureCodec.class.getCanonicalName();
  ...
  /** Raw coder factory for the XNOR codec. */
  public static final String IO_ERASURECODE_CODEC_XNOR_RAWCODERS_KEY =
      IO_ERASURECODE_CODEC + "xnor.rawcoders";
  ...
  private static String getCodecClassName(Configuration conf, String codec) {
    ...
    case ErasureCodeConstants.XNOR_CODEC_NAME:
      return conf.get(
          CodecUtil.IO_ERASURECODE_CODEC_XNOR_KEY,
          CodecUtil.IO_ERASURECODE_CODEC_XNOR);
    default:
